...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 30 16:32:07 2021

@author: nitinsinghal
"""

# Kaggle NFL Big Data Bowl 2022
...
# Load the data
games = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/games.csv')
players = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/players.csv')
plays = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/plays.csv')
PFFScoutingData = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/PFFScoutingData.csv')
tracking2018 = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/tracking2018.csv')
tracking2019 = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/tracking2019.csv')
tracking2020 = pd.read_csv('/./Kaggle/nfl-big-data-bowl-2022/tracking2020.csv')
